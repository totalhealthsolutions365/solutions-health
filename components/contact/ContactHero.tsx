...
export function ContactHero() {
  return (
    <section className="relative min-h-[30dvh] sm:min-h-[40dvh] bg-primary flex items-center overflow-hidden pt-24">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center py-16">
        ...
        >
          Ready to bring a wellness day to your company? Fill out the form and
